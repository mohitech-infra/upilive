...
export default function Dashboard() {
    ...
    const overlayUrl = profile ? `${['localhost', '127.0.0.1', 'capacitor://'].some(sub => window.location.origin.includes(sub)) ? 'https://upialert-live.netlify.app' : window.location.origin}/overlay/${profile.overlay_token}` : ''
